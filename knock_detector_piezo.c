...
const int threshold = 4000;           // Minimum signal from the piezo to register as a knock ***********************************************************CHECK
...
void InitADC(){
	...
	DrvADC_Open(ADC_SINGLE_END, ADC_CONTINUOUS_OP,0x01, INTERNAL_RC22MHZ, 1);
}
